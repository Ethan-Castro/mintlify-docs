...
description: "Run open-weight language models on your own laptop — no cloud, no API key, no WiFi. The companion page for the CUNY HPCC Local LLMs workshop with Ethan Castro and Hussam Ali."
---
...
- **Move to a real GPU** via the [CUNY HPCC](/index) or, for bigger work, [Empire AI](/empire-ai/index).
