...
<ResponseField name="api" type="API">
  Configuration for API settings. Learn more about API pages in the [Mintlify API component docs](https://mintlify.com/docs/api-playground/mdx/configuration).
    ...
    <ResponseField name="playground" type="Playground">
      ...
      <Expandable title="Playground">
        <ResponseField name="mode" default="show" type='"show" | "simple" | "hide"'>
          ...
          Learn more in the [Mintlify OpenAPI setup docs](https://mintlify.com/docs/api-playground/openapi/setup)
        </ResponseField>
      </Expandable>
    </ResponseField>
