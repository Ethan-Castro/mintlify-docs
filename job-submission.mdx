...
Every job on CUNY HPCC is submitted through **SLURM**. This page collects annotated templates for the common job shapes. Copy one, edit the `#SBATCH` directives, add your `module load`s, and submit with `sbatch`.
