...
| Role | Leader |
| --- | --- |
| Interim executive director | Robert Harrison |
...
Robert Harrison serves as the executive bridge between board-level strategy and operational delivery. His role centers on institutional coordination, long-range planning, and keeping the consortium aligned with state funding and member expectations. Kiran Keshav leads the research-computing side of the platform: cluster operations, technical direction, and the translation of Empire AI's shared-infrastructure model into a usable environment for researchers.
