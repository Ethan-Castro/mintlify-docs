...
description: "The rules every CUNY HPCC user is expected to follow."
---

Using CUNY HPCC means agreeing to CUNY's acceptable-use, privacy, and IT security policies. This page summarizes the rules most likely to trip up new users. Where it disagrees with official CSI/CUNY policy, the official policy wins.
...
- **Credit HPCC in publications.** Every paper, poster, thesis, or report that used CUNY HPCC resources must include the acknowledgement below, and a paper copy of the finished work must be sent to the helpline.
